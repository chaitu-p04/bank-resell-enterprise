<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
 ...
 <%@page import="java.sql.*, com.hit.utility.DBUtil" errorPage="errorpage.jsp"%>
...
<body>
   ...
   <div class="col-md-8">
    <div class="marquee" style="border:2px black hidden; background-color:white; padding-top:0px;">
        ...
        <div class="marquee-content" style="align:center; padding-top:100px;min-height:750px;background-color:#0087BE">
