...
<body>
          ...
          <div class="marquee" style="border:2px #0087BE solid;background-color:white">
          <h4 style="background-color:#0087BE; margin-top:-1.8px; padding: 5px;"><i class="glyphicon glyphicon-volume-up"></i> 
