      ...
      <div id="collapsable-nav" class="collapse navbar-collapse hidden-lg hidden-md">
        <ul id="nav-list" class="nav navbar-nav navbar-left pull-left">
            ...
            <!-- <li class="dropdown">
              ...
              <li class="dropdown">
                <a class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-animations="fadeIn fadeInLeft fadeInUp fadeInRight">Auctions
                <!--Dropdown under tender category -->
                  
                    <span class="caret"></span></a>
                <ul class="dropdown-menu">
                  <li><a href="vendorViewTender.jsp">View all Auctions</a></li>
                  <li><a href="loginFailed.jsp">Apply for a Auction</a></li>
            ...
            <li>
              ...
              <form class="navbar-form hidden-xs" action="vendorSearchTender.jsp"  >
                <div class="form-group" >
                  <input type="text" class="form-control" placeholder="Find Auctions by name" style="margin-left: 150px;" required>
                </div>
