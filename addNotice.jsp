...
<body>
   ...
   <div class="col-md-8">
	...
	<form action="AddNoticeSrv" method="get">
		<table style="background-color:white">
		   ...
		   <tr><td style="color:red">	Descripton : </td><td> <textarea rows="4" cols="40" style="font-size:15px" name="info" required="required"></textarea></td></tr>
			...
			<tr><td colspan="2" align="center" value="Launch"><input type="submit" style="background-color:#0087BE;color:white;" value="Add Notice to Notice Board" name="user"></td></tr>
