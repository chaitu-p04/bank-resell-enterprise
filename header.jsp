        ...
        <div class="container" >
            <div class="navbar-header my-1"> <!-- Header navigation-->
                <a href="#" class="pull-left">
                    <img src="banklogo.jpg" alt="Bank of London" width="70px" height="70px"/>
                </a>
                    <a class="navbar-brand" href="#"><h1>Bank Of London</h1></a> <!-- Library Name fixed-->
                    <a href="#"><p> Resell Enterprise</p></a>
            </div>
