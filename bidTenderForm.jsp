    ...
    <!-- <div class="marquee" style="border:2px black hidden; background-color:white">
      ...
      --> 
     	...
     	<table style="border-radius:10px" >
			<tr >
				<td id="show" style="min-width:632px;min-height:0px;color:black">Enter Bid Amount And Deadline To Bid</td>
			</tr>
		</table>
	...
	<form action="BidTenderSrv" method="post">
		<table style="background-color:white">
		   ...
		   <input type="hidden" name="biddeadline" required="required" value="<%= tender.getDeadline()%>">				
			<tr><td colspan="2" align="center" value="Launch"><input type="submit" value="Bid Now" style="background-color:#0087BE;color:white;"></td></tr>
