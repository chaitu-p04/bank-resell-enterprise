   ...
   <div class="col-md-8">
	...
	<form action="CreateTenderSrv" method="post">
		<table style="background-color:white">
			<th colspan="2">Add New Auctions</th>
			<tr><td>	Auction Name  : </td><td><input type="text" name="tname" required="required"></td></tr>
			<tr><td>    Auction type  : </td><td><select name="ttype" required="required" >
