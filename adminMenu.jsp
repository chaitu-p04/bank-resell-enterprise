        ...
        <ul id="nav-list" class="nav navbar-nav navbar-left pull-left">
            ...
            <!-- <li class="dropdown">
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a href="viewTender.jsp">View all Auctions</a></li>
                  <li><a href="createTender.jsp">Create New Auction</a></li>
                  <li><a href="viewTenderBids.jsp">View Auction Bids</a></li>
                  <li><a href="viewTenderBids.jsp">Accept a bid</a></li>
                  <li><a href="viewAssignedTenders.jsp">View Assigned Auctions</a></li>
                  </ul>
             </li>
            ...
            <li>
              ...
              <form class="navbar-form hidden-xs" action="searchTender.jsp"  >
                <div class="form-group" >
                  <input type="text" name="tid" class="form-control" placeholder="Find Auctions by name or AuctionId" style="margin-left:10px;" required>
                </div>
