...
<body>
   ...
   <div class="col-md-8">
    <div class="marquee" style="border:2px black hidden; background-color:white">
        ...
        <div class="marquee-content" style="align:center; padding-top:200px;min-height:750px;background-color:#0087BE">
     		<h1><center>Hey Admin! Welcome to Bank Of London</center></h1>
     		<h2><center>Here You can manage your vendors, add auctions and assign it to vendors according to their high bids</center></h2>
