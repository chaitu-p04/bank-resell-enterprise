...
<body>
	...
	<div class="clearfix hidden-sm hidden-xs" style="color:white;background-color: #0087BE; margin-top:-15px; margin-bottom: 12px"><marquee>Welcome to Bank Of London</marquee>
   ...
   <div class="col-md-8">
    <div class="marquee" style="border:2px black hidden; background-color:white">
        ...
        <div class="marquee-content" style="align:center; padding-top:200px; padding-bottom:min-height:750px;background-color:#0087BE">
     		<h1><center>Hey Dude! Welcome to Bank Of London</center></h1>
     		<h2><center>Here You can view auctions and bid for tenders according to their deadline and base price</center></h2>
