...
<body>
	...
	<div class="clearfix hidden-sm hidden-xs"
		style="color: white; background-color: #0087BE; margin-top: -15px; margin-bottom: 12px">
	...
	<div class="container-fluid">
        ...
        <div class="marquee-content" style="align:center; padding-top:200px;min-height:750px;background-color:cyan">
			...
			<table style="border-radius: 10px">
				<tr>
					<td id="show"
						style="min-width: 850px; color: #0087BE; background-color: white">Delete
						Notices</td>
				</tr>
			</table>
			...
			<table style="background-color: white">
				<tr
					style="color: white; font-size: 22px; font-weight: bold; background-color: #0087BE">
					<td>Notice Id</td>
					<td>Title</td>
					<td>Description</td>
					<td>Remove ?</td>
